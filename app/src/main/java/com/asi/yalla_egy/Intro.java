...
import Utile.CirclePageIndicator;
import Utile.ColorShades;
...
public class Intro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * */
        if(new SessionManager(Intro.this).isLoggedIn())
        {
            Intent intent=new Intent(Intro.this,LoginSignup.class);
    ...
    public void Login(View view) {
        Intent intent=new Intent(Intro.this,LoginSignup.class);
        startActivity(intent.putExtra("Flag","0"));
    }
